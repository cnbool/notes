title: xmemcached配置和使用
id: 1562
categories:
  - Java
date: 2014-10-28 21:54:06
tags:
---
...
[code lang="xml"]
	...
	<bean id="memc1" factory-bean="memcachedClientBuilder"
		factory-method="build" destroy-method="shutdown" />
	<bean id="memc2" factory-bean="memcachedClientBuilder"
		factory-method="build" destroy-method="shutdown" />
	<bean id="memc3" factory-bean="memcachedClientBuilder"
		factory-method="build" destroy-method="shutdown" />
```
<!--more-->
